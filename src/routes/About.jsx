      ...
      <div className="collapsible-content">
        <div className="content-inner">
          <p className="bold">
            ...
            av handledaren få syn på alternativa problemlösningar och vägar framåt.
          </p>
          <p>
            ...
            som en problemlösande, enande och stressreducerande insats.
          </p>
          <p>
            ...
            Därigenom växer var och en i sin professionella hållning.
          </p>
          <p>
      ...
      <div className="collapsible-content">
        <div className="content-inner">
          <p className="bold">
            ...
            utgå från den verklighet som den aktuella arbetsgruppen arbetar och befinner sig i.
          </p>
          <p>
            Handledning löper ofta mellan cirka en till sex terminer, med en 
            ...
            sin utveckling och utmaning belyst och diskuterad.
          </p>
          <p>
            Vi på handledning.se 
      ...
      <div className="collapsible-content">
        <div className="content-inner">
          <p className="bold">
            ...
            anpassas efter gruppens förutsättningar, erfarenheter och sammansättning.
          </p>
          <p>
            ...
            kan väcka, får vi lättare att urskilja och förhålla oss till mönster, system och processer.
          </p>
          <p>
            ...
            klientgrupp eller ett nytt arbetsområde introduceras.
          </p>
          <p>
      ...
      <div className="collapsible-content">
        <div className="content-inner">
          <p className="bold">
            ...
            på bordet” blir de möjliga att skärskåda och få grepp om.
          </p>
          <p>
            ...
            för att deltagarna i gruppen bättre ska förstå sitt handlande och/eller 
            de känslor som situationen väcker.
          </p>
          <p>
